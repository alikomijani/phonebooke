...
function Contacts({fetchContact , setOffset , setLimit}) {
    ...
    return (
        ...
        <CreateForm isOpen={open} toggle={()=>setOpen(false) }/>
        limit:
...
export default connect(null, { fetchContact,setOffset , setLimit })(Contacts)
